...
AVS_UNIT_TEST(parse_url, invalid_first_character) {
    AVS_UNIT_ASSERT_NULL(avs_url_parse("+http://acs.avsystem.com"));
    AVS_UNIT_ASSERT_NULL(avs_url_parse("1http://acs.avsystem.com"));
    AVS_UNIT_ASSERT_NULL(avs_url_parse(".http://acs.avsystem.com"));
}
