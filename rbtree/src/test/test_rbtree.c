...
static int CONST_20 = 20;
static int CONST_23 = 23;
static int CONST_30 = 30;
static int CONST_34 = 34;
static int CONST_40 = 40;
static int CONST_45 = 45;
static int CONST_50 = 50;
static int CONST_56 = 56;
static int CONST_60 = 60;
static int CONST_67 = 67;
static int CONST_70 = 70;
static int CONST_78 = 78;
static int CONST_80 = 80;
static int CONST_89 = 89;
static int CONST_90 = 90;
static int CONST_91 = 91;
static int CONST_100 = 100;
static int CONST_102 = 102;
static int CONST_110 = 110;
static int CONST_113 = 113;
static int CONST_120 = 120;
static int CONST_124 = 124;
static int CONST_130 = 130;
static int CONST_135 = 135;
static int CONST_140 = 140;
static int CONST_146 = 146;
static int CONST_150 = 150;
static int CONST_157 = 157;
...
AVS_UNIT_TEST(rbtree, lower_bound) {
    ...
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_1) == AVS_RBTREE_FIND(tree, &CONST_10));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_10) == AVS_RBTREE_FIND(tree, &CONST_10));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_12) == AVS_RBTREE_FIND(tree, &CONST_20));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_20) == AVS_RBTREE_FIND(tree, &CONST_20));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_23) == AVS_RBTREE_FIND(tree, &CONST_30));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_30) == AVS_RBTREE_FIND(tree, &CONST_30));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_34) == AVS_RBTREE_FIND(tree, &CONST_40));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_40) == AVS_RBTREE_FIND(tree, &CONST_40));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_45) == AVS_RBTREE_FIND(tree, &CONST_50));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_50) == AVS_RBTREE_FIND(tree, &CONST_50));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_56) == AVS_RBTREE_FIND(tree, &CONST_60));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_60) == AVS_RBTREE_FIND(tree, &CONST_60));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_67) == AVS_RBTREE_FIND(tree, &CONST_70));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_70) == AVS_RBTREE_FIND(tree, &CONST_70));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_78) == AVS_RBTREE_FIND(tree, &CONST_80));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_80) == AVS_RBTREE_FIND(tree, &CONST_80));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_89) == AVS_RBTREE_FIND(tree, &CONST_90));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_90) == AVS_RBTREE_FIND(tree, &CONST_90));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_91) == AVS_RBTREE_FIND(tree, &CONST_100));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_100) == AVS_RBTREE_FIND(tree, &CONST_100));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_102) == AVS_RBTREE_FIND(tree, &CONST_110));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_110) == AVS_RBTREE_FIND(tree, &CONST_110));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_113) == AVS_RBTREE_FIND(tree, &CONST_120));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_120) == AVS_RBTREE_FIND(tree, &CONST_120));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_124) == AVS_RBTREE_FIND(tree, &CONST_130));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_130) == AVS_RBTREE_FIND(tree, &CONST_130));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_135) == AVS_RBTREE_FIND(tree, &CONST_140));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_140) == AVS_RBTREE_FIND(tree, &CONST_140));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_146) == AVS_RBTREE_FIND(tree, &CONST_150));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_LOWER_BOUND(tree, &CONST_150) == AVS_RBTREE_FIND(tree, &CONST_150));
    AVS_UNIT_ASSERT_NULL(AVS_RBTREE_LOWER_BOUND(tree, &CONST_157));
...
AVS_UNIT_TEST(rbtree, upper_bound) {
    ...
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_1) == AVS_RBTREE_FIND(tree, &CONST_10));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_10) == AVS_RBTREE_FIND(tree, &CONST_20));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_12) == AVS_RBTREE_FIND(tree, &CONST_20));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_20) == AVS_RBTREE_FIND(tree, &CONST_30));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_23) == AVS_RBTREE_FIND(tree, &CONST_30));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_30) == AVS_RBTREE_FIND(tree, &CONST_40));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_34) == AVS_RBTREE_FIND(tree, &CONST_40));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_40) == AVS_RBTREE_FIND(tree, &CONST_50));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_45) == AVS_RBTREE_FIND(tree, &CONST_50));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_50) == AVS_RBTREE_FIND(tree, &CONST_60));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_56) == AVS_RBTREE_FIND(tree, &CONST_60));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_60) == AVS_RBTREE_FIND(tree, &CONST_70));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_67) == AVS_RBTREE_FIND(tree, &CONST_70));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_70) == AVS_RBTREE_FIND(tree, &CONST_80));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_78) == AVS_RBTREE_FIND(tree, &CONST_80));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_80) == AVS_RBTREE_FIND(tree, &CONST_90));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_89) == AVS_RBTREE_FIND(tree, &CONST_90));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_90) == AVS_RBTREE_FIND(tree, &CONST_100));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_91) == AVS_RBTREE_FIND(tree, &CONST_100));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_100) == AVS_RBTREE_FIND(tree, &CONST_110));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_102) == AVS_RBTREE_FIND(tree, &CONST_110));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_110) == AVS_RBTREE_FIND(tree, &CONST_120));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_113) == AVS_RBTREE_FIND(tree, &CONST_120));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_120) == AVS_RBTREE_FIND(tree, &CONST_130));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_124) == AVS_RBTREE_FIND(tree, &CONST_130));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_130) == AVS_RBTREE_FIND(tree, &CONST_140));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_135) == AVS_RBTREE_FIND(tree, &CONST_140));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_140) == AVS_RBTREE_FIND(tree, &CONST_150));
    AVS_UNIT_ASSERT_TRUE(AVS_RBTREE_UPPER_BOUND(tree, &CONST_146) == AVS_RBTREE_FIND(tree, &CONST_150));
    AVS_UNIT_ASSERT_NULL(AVS_RBTREE_UPPER_BOUND(tree, &CONST_150));
    AVS_UNIT_ASSERT_NULL(AVS_RBTREE_UPPER_BOUND(tree, &CONST_157));
