...
int AVS_NET_EADDRINUSE = EADDRINUSE;

extern int AVS_NET_EADDRNOTAVAIL;
int AVS_NET_EADDRNOTAVAIL = EADDRNOTAVAIL;

extern int AVS_NET_EAFNOSUPPORT;
int AVS_NET_EAFNOSUPPORT = EAFNOSUPPORT;

extern int AVS_NET_EAGAIN;
int AVS_NET_EAGAIN = EAGAIN;

extern int AVS_NET_EALREADY;
int AVS_NET_EALREADY = EALREADY;

extern int AVS_NET_EBADMSG;
int AVS_NET_EBADMSG = EBADMSG;

extern int AVS_NET_ECANCELED;
int AVS_NET_ECANCELED = ECANCELED;

extern int AVS_NET_ECONNABORTED;
int AVS_NET_ECONNABORTED = ECONNABORTED;

extern int AVS_NET_ECONNREFUSED;
int AVS_NET_ECONNREFUSED = ECONNREFUSED;

extern int AVS_NET_ECONNRESET;
int AVS_NET_ECONNRESET = ECONNRESET;

extern int AVS_NET_EDESTADDRREQ;
int AVS_NET_EDESTADDRREQ = EDESTADDRREQ;

extern int AVS_NET_EHOSTUNREACH;
int AVS_NET_EHOSTUNREACH = EHOSTUNREACH;

extern int AVS_NET_EINPROGRESS;
int AVS_NET_EINPROGRESS = EINPROGRESS;

extern int AVS_NET_EISCONN;
int AVS_NET_EISCONN = EISCONN;

extern int AVS_NET_EMSGSIZE;
int AVS_NET_EMSGSIZE = EMSGSIZE;

extern int AVS_NET_ENAMETOOLONG;
int AVS_NET_ENAMETOOLONG = ENAMETOOLONG;

extern int AVS_NET_ENETDOWN;
int AVS_NET_ENETDOWN = ENETDOWN;

extern int AVS_NET_ENETRESET;
int AVS_NET_ENETRESET = ENETRESET;

extern int AVS_NET_ENETUNREACH;
int AVS_NET_ENETUNREACH = ENETUNREACH;

extern int AVS_NET_ENOBUFS;
int AVS_NET_ENOBUFS = ENOBUFS;

extern int AVS_NET_ENODATA;
int AVS_NET_ENODATA = ENODATA;

extern int AVS_NET_ENOLINK;
int AVS_NET_ENOLINK = ENOLINK;

extern int AVS_NET_ENOMSG;
int AVS_NET_ENOMSG = ENOMSG;

extern int AVS_NET_ENOPROTOOPT;
int AVS_NET_ENOPROTOOPT = ENOPROTOOPT;

extern int AVS_NET_ENOSR;
int AVS_NET_ENOSR = ENOSR;

extern int AVS_NET_ENOSYS;
int AVS_NET_ENOSYS = ENOSYS;

extern int AVS_NET_ENOTCONN;
int AVS_NET_ENOTCONN = ENOTCONN;

extern int AVS_NET_ENOTSOCK;
int AVS_NET_ENOTSOCK = ENOTSOCK;

extern int AVS_NET_ENOTSUP;
int AVS_NET_ENOTSUP = ENOTSUP;

extern int AVS_NET_EOPNOTSUPP;
int AVS_NET_EOPNOTSUPP = EOPNOTSUPP;

extern int AVS_NET_EOVERFLOW;
int AVS_NET_EOVERFLOW = EOVERFLOW;

extern int AVS_NET_EPROTO;
int AVS_NET_EPROTO = EPROTO;

extern int AVS_NET_EPROTONOSUPPORT;
int AVS_NET_EPROTONOSUPPORT = EPROTONOSUPPORT;

extern int AVS_NET_EPROTOTYPE;
int AVS_NET_EPROTOTYPE = EPROTOTYPE;

extern int AVS_NET_ETIME;
int AVS_NET_ETIME = ETIME;

extern int AVS_NET_ETIMEDOUT;
int AVS_NET_ETIMEDOUT = ETIMEDOUT;

extern int AVS_NET_EWOULDBLOCK;
int AVS_NET_EWOULDBLOCK = EWOULDBLOCK;
