...
static void test_impl(const unsigned char *key, size_t key_len,
    ...
    if (input_len) {
        encrypted = (unsigned char *) avs_calloc(input_len,
                                                 sizeof(unsigned char));
        decrypted = (unsigned char *) avs_calloc(input_len,
                                                 sizeof(unsigned char));
    }
...
AVS_UNIT_TEST(avs_crypto_aead, no_aad) {
    ...
    // From PyCryptodome
    const unsigned char ciphertext[] = {
        0xa5, 0xdb, 0xea, 0x4f, 0x18, 0x68, 0x5b, 0xb1,
        0x2b, 0x3d, 0x70, 0xf1, 0xde, 0xc0, 0x6e, 0x9a,
        0x92, 0xca, 0x75, 0x04
    };
...
AVS_UNIT_TEST(avs_crypto_aead, long_message) {
    const char *plaintext =
        "Bacon ipsum dolor amet t-bone capicola chuck meatloaf ham. Leberkas "
    ...
    // From PyCryptodome
    const unsigned char ciphertext[] = {
        
    };
...
AVS_UNIT_TEST(avs_crypto_aead, authenticate_only) {
    ...
    // From PyCryptodome
    const unsigned char ciphertext[] = {
        0x18, 0x3a, 0xc3, 0x4a, 0x05, 0xbe, 0x03, 0x78,
        0x10, 0x7d, 0x17, 0x2c, 0xa4, 0x27, 0x3a, 0x86
    };
