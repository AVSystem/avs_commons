...
typedef avs_net_abstract_socket_t *(*avs_stream_net_getsock_t)(
        avs_stream_t *stream);

typedef avs_error_t (*avs_stream_net_setsock_t)(
        avs_stream_t *stream, avs_net_abstract_socket_t *socket);
