...
static avs_coap_msg_t *make_msg_template_with_data(void *buffer,
    ...
    avs_coap_msg_t *msg =
            make_msg_template(buffer,
                              offsetof(avs_coap_msg_t, content) + data_size);
...
#define DECLARE_MSG_TEMPLATE(VarName, SizeVarName, DataSize) \
    const size_t SizeVarName = \
            offsetof(avs_coap_msg_t, content) + (DataSize); \
...
#define DECLARE_MSG_TEMPLATE_WITH_DATA(VarName, SizeVarName, Data) \
    const size_t SizeVarName = \
            offsetof(avs_coap_msg_t, content) + sizeof(Data) - 1; \
...
AVS_UNIT_TEST(coap_builder, option_opaque) {
    ...
    _avs_coap_opt_set_short_length((avs_coap_opt_t *)msg_tpl->content, 3);
...
AVS_UNIT_TEST(coap_builder, option_multiple_ints) {
    ...
    _avs_coap_opt_set_short_length((avs_coap_opt_t *)&msg_tpl->content[0], 1);
    msg_tpl->content[1] = 0x10;
    _avs_coap_opt_set_short_length((avs_coap_opt_t *)&msg_tpl->content[2], 2);
    msg_tpl->content[3] = 0x21;
    msg_tpl->content[4] = 0x20;
    _avs_coap_opt_set_short_length((avs_coap_opt_t *)&msg_tpl->content[5], 4);
    msg_tpl->content[6] = 0x43;
    msg_tpl->content[7] = 0x42;
    msg_tpl->content[8] = 0x41;
    msg_tpl->content[9] = 0x40;
    _avs_coap_opt_set_short_length((avs_coap_opt_t *)&msg_tpl->content[10], 8);
    ...
    _avs_coap_opt_set_short_length((avs_coap_opt_t *)&msg_tpl->content[19], 1);
    msg_tpl->content[20] = 0xFF;
    _avs_coap_opt_set_short_length((avs_coap_opt_t *)&msg_tpl->content[21], 0);
